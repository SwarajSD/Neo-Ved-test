...
export default function PersonalBrandingPage() {
  ...
  <div className="max-w-md mx-auto overflow-x-auto">
    <table className="table-auto border border-white w-full text-left text-sm">
      ...
      <tbody>
        <tr>
          <td className="border border-white px-4 py-2">Mastering consulting & Advisory Skills</td>
        ...
        <tr>
          <td className="border border-white px-4 py-2">LinkedIn Hyper Personalisation</td>
          <td className="border border-white px-4 py-2">Rs.4999/-</td>
        </tr>
        <tr>
          <td className="border border-white px-4 py-2">Monetization Strategies with your personal brand</td>
          <td className="border border-white px-4 py-2">Rs.4999/-</td>
        </tr>
      </tbody>
    </table>
